...
class WebController extends AbstractController
{
    ...
    #[Route('/dossier_medical', name: 'app_dossier_medical')]
    public function dossier_medical(): Response
    {
        return $this->render('pages/dossier_medical.html.twig');
    }

    #[Route('/Rapports_Ordonnances', name: 'app_Rapports_Ordonnances')]
    public function Rapports_Ordonnances(): Response
    {
        return $this->render('pages/Rapports_Ordonnances.html.twig');
    }

    #[Route('/ia-db', name: 'app_Assistance_IA')]
    public function Assistance_IA(): Response
    {
        return $this->render('pages/Assistance_IA.html.twig');
    }
    ...
    #[Route('/departments/details', name: 'app_department_details')]
    ...
    #[Route('/services/details', name: 'app_service_details')]
