...
class FrontController extends AbstractController
{
    ...
    #[Route('/magazine/{id}/generate-summary', name: 'front_magazine_generate_summary', methods: ['POST'])]
    public function generateMagazineSummary(
        Magazine $magazine,
        SummaryService $summaryService
    ): JsonResponse {
        try {
            $summary = $summaryService->summarize((string) $magazine->getDescription(), 'magazine');
