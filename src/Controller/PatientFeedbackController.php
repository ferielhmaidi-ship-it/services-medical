...
class PatientFeedbackController extends AbstractController
{
    ...
    public function newForRdv(
        ...
        \App\Service\SentimentAnalysisService $sentimentService,
        \App\Service\MedecinSyncService $syncService
    ): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($rating < 1 || $rating > 5) {
                ...
                // Analyze sentiment via Flask API
                ...
                if ($analysisResult) {
                    ...
                    $feedback->setSentimentScore((float)$rating);
                }
                ...
                $syncService->syncAiScore($rendezVous->getDoctor());
