...
class BookingController extends AbstractController
{
    ...
    public function __construct(EmailService $emailService, MedecinRepository $medecinRepo, LoggerInterface $logger)
    {
    ...
    public function cancelAppointment(int $id, AppointmentRepository $apptRepo, EntityManagerInterface $em): JsonResponse
    {
        ...
        if ($doctor) {
            try {
                ...
                $this->logger->error('Email cancellation failed: ' . $e->getMessage());
            }
        }
