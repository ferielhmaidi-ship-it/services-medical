...
class Medecin extends BaseUser
{
    ...
    #[ORM\Column(type: 'string', length: 20, nullable: true, name: 'ai_sentiment_label')]
    private ?string $aiSentimentLabel = null;
    ...
    public function getAiSentimentLabel(): ?string
    {
        return $this->aiSentimentLabel;
    }

    public function setAiSentimentLabel(?string $aiSentimentLabel): self
    {
        $this->aiSentimentLabel = $aiSentimentLabel;
